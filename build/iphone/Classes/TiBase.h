...
// in simulator we redefine to format for Niiki Developer console
...
{\
	NSString * exceptionName = [@"org.niiki." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.niiki";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UINiikiNativeItemNone = -1, 
	UINiikiNativeItemSpinner = -2,
	UINiikiNativeItemProgressBar = -3,
	
	UINiikiNativeItemSlider = -4,
	UINiikiNativeItemSwitch = -5,
	UINiikiNativeItemMultiButton = -6,
	UINiikiNativeItemSegmented = -7,
	
	UINiikiNativeItemTextView = -8,
	UINiikiNativeItemTextField = -9,
	UINiikiNativeItemSearchBar = -10,
	
	UINiikiNativeItemPicker = -11,
	UINiikiNativeItemDatePicker = -12,
	
	UINiikiNativeItemInfoLight = -13,
	UINiikiNativeItemInfoDark = -14,
	
	UINiikiNativeItemDisclosure = -15,
	
	UINiikiNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Niiki instances of
