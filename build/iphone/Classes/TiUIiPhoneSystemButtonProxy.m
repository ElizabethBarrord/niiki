...
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(ACTIVITY,UINiikiNativeItemSpinner,@"UI.iPhone.SystemButtonStyle.ACTIVITY",@"5.4.0",@"UI.iOS.SystemButtonStyle.ACTIVITY");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(SPINNER,UINiikiNativeItemSpinner,@"UI.iPhone.SystemButtonStyle.SPINNER",@"5.4.0",@"UI.iOS.SystemButtonStyle.SPINNER");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(INFO_LIGHT,UINiikiNativeItemInfoLight,@"UI.iPhone.SystemButtonStyle.INFO_LIGHT",@"5.4.0",@"UI.iOS.SystemButtonStyle.INFO_LIGHT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(INFO_DARK,UINiikiNativeItemInfoDark,@"UI.iPhone.SystemButtonStyle.INFO_DARK",@"5.4.0",@"UI.iOS.SystemButtonStyle.INFO_DARK");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(DISCLOSURE,UINiikiNativeItemDisclosure,@"UI.iPhone.SystemButtonStyle.DISCLOSURE",@"5.4.0",@"UI.iOS.SystemButtonStyle.DISCLOSURE");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(CONTACT_ADD,UINiikiNativeItemContactAdd,@"UI.iPhone.SystemButtonStyle.CONTACT_ADD",@"5.4.0",@"UI.iOS.SystemButtonStyle.CONTACT_ADD");
